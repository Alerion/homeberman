...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.death_time'
        db.add_column('main_player', 'death_time', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.death_time'
        db.delete_column('main_player', 'death_time')
    ...
    models = {
        ...
        'main.cell': {
            ...
            'bomb_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'main.player': {
            ...
            'death_time': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
