...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cell.bomb_time'
        db.alter_column('main_cell', 'bomb_time', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Player.death_time'
        db.alter_column('main_player', 'death_time', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Cell.bomb_time'
        db.alter_column('main_cell', 'bomb_time', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Player.death_time'
        db.alter_column('main_player', 'death_time', self.gf('django.db.models.fields.BigIntegerField')())
