...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_game', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 9, 16, 39, 1, 25044), blank=True), keep_default=False)

        # Adding field 'Game.started'
        db.add_column('main_game', 'started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.created'
        db.delete_column('main_game', 'created')

        # Deleting field 'Game.started'
        db.delete_column('main_game', 'started')
