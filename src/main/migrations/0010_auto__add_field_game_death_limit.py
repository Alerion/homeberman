...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.death_limit'
        db.add_column('main_game', 'death_limit', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.death_limit'
        db.delete_column('main_game', 'death_limit')
