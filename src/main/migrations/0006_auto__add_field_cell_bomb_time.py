...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cell.bomb_time'
        db.add_column('main_cell', 'bomb_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cell.bomb_time'
        db.delete_column('main_cell', 'bomb_time')
