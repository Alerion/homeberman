...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.last_move_time'
        db.alter_column('main_player', 'last_move_time', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Player.last_move_time'
        db.alter_column('main_player', 'last_move_time', self.gf('django.db.models.fields.BigIntegerField')())
