...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Player', fields ['game', 'user']
        db.create_unique('main_player', ['game_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Player', fields ['game', 'user']
        db.delete_unique('main_player', ['game_id', 'user_id'])
